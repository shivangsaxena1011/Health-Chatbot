...
import { HeartPulse, Mail, Lock, User, ArrowRight, ShieldCheck, AlertCircle, Sparkles } from 'lucide-react';
        ...
        <form onSubmit={handleSubmit} className="p-6 sm:p-8 space-y-4">
          ...
          {!isSignUp && (
            <button
              ...
              className="w-full py-2.5 bg-emerald-50 hover:bg-emerald-100 text-emerald-800 text-xs font-bold rounded-xl transition-all border border-emerald-200 flex items-center justify-center space-x-1.5"
            >
          ...
          {/* Google OAuth (No dead button!) */}
          <a
            href="/api/auth/google"
            className="w-full py-2.5 bg-white border border-slate-200 text-slate-700 text-xs font-semibold rounded-xl hover:bg-slate-50 transition-all flex items-center justify-center space-x-2 shadow-sm"
          >
